# this is mostly boilet plate and copy paste, only code changes are at line 41 to 44
...
def echo(update: Update, context: CallbackContext) -> None:
    ...
    response_from_ai = generative.oci_gen_chat(update.message.text).output_text

    if update.message.text:
        update.message.reply_text(response_from_ai)
